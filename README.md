...
This template contains a project, `project-sunshine`, and an app, `api`,
...
1. Replace all instances of `project-sunshine` with your application name. **This includes the folder included in this repository.**
...
This template includes a project `project-sunshine` which should be renamed
...
all instances of `project-sunshine` with your app's name.
